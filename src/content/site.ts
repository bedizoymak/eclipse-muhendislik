...
const trModules = [
  ...
  ["Personel ve Görev Yönetimi", "Kullanıcı rolleri, görev akışları, onay süreçleri ve iş yüklerini sistematik şekilde yönetir.", "Yöneticiler ekip performansını, sorumlulukları ve geciken işleri dashboard üzerinden izler.", "İş takibi kişisel hafızadan kurumsal sisteme taşınır."],
  ...
  ["Raporlama ve Yönetici Dashboardları", "Yönetim kararları için satış, finans, stok ve operasyon verilerini tek panelde birleştirir.", "Üst yönetim KPI, trend ve performans göstergelerini gerçek zamanlı takip eder.", "Karar süreçleri ölçülebilir veriyle desteklenir."],
...
export const siteContent = {
  tr: {
    ...
    seo: {
      ...
      modules: ["Modüller | Eclipse ERP, CRM ve Veri Analizi Modülleri", "CRM, ERP, finans, stok, görev, teklif, dashboard, Veri Analizi ve AI-Yapay Zeka modülleriyle kurumsal yönetim."],
      ...
      dataAnalytics: ["Veri Analizi | Eclipse Dashboard ve KPI Sistemleri", "Eclipse Veri Analizi modülleri gerçek zamanlı dashboard, KPI takibi, finans, satış, stok ve operasyon analitiği sunar."],
    ...
    pages: {
      ...
      dataAnalytics: {
        ...
        title: "Gerçek zamanlı dashboardlar ve yönetilebilir KPI mimarisi.",
    ...
    solutionCards: [
      ...
      ["Veri Analizi", "KPI, finans, satış, stok ve performans verilerini karar destek dashboardlarına dönüştürür."],
      ["Dijital Dönüşüm", "Kağıt, Excel ve parçalı sistem bağımlılığını azaltarak süreçleri yeniden tasarlar."],
      ["Custom SaaS Development", "Kuruma özel web, mobil ve platform tabanlı yazılım ürünleri geliştirir."],
    ...
    analyticsItems: ["Gerçek zamanlı dashboardlar", "KPI takibi", "Finans analitiği", "Satış analitiği", "Stok analitiği", "Personel performans analitiği", "Yönetim raporlaması", "Operasyonel görünürlük"],
    ...
    industries: [
      ...
      ["Kurumsal Ofisler", "Ekipler farklı araçlarda çalışır ve raporlama standardı oluşmaz.", "CRM, görev, finans ve dashboard yapısı tek platformda konumlanır.", "Yönetim raporları standart ve karşılaştırılabilir hale gelir."],
      ...
      ["Finans Ekipleri", "Cari, tahsilat ve nakit akışı verileri parçalı raporlanır.", "Finans dashboardları ve Veri Analizi modülleri riskleri görünür kılar.", "Finansal kontrol ve raporlama kalitesi artar."],
