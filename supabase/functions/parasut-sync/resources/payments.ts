...
// Phase 1.2 synced sales_invoices payments; Phase 4 adds purchase_bills
// payments (expense payments). bank_fees/salaries/taxes payments remain out
// of scope and are not represented here.
//
...
// NOT guessed from the payment itself. They are the invoice/bill this
...
export function mapPayment(item: JsonApiResource, payableParasutId: number, payableType: "sales_invoices" | "purchase_bills" = "sales_invoices"): PaymentRow {
